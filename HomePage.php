<?php  
   ...
   $sql = "SELECT title, id, length,image FROM movies";
...
<head>
  ...
  <title>Watch movies & shows</title>
          ...
          <div class="col-sm-12">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
              ...
              <a href="HomePage.html" class="navbar-brand">
                <img src="images/logo.png" class="img-fluid logo" alt="logo.jpeg" />
              </a>
          ...
          <div class="slider-inner h-100">
            <div class="row align-items-center h--100">
              <div class="col-xl-6 col-lg-12 col-md-12">
                ...
                <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft"
                  data-delay-in="0.6">
                  Dune Part <span style="font-size: 140%;">2</span>
                </h1>
                <div class="d-flex flex-wrap align-items-center fadeInLeft animated" data-animation-in="fadeInLeft"
                  style="opacity: 1">
                  <div class="slider-ratting d-flex align-items-center mr-4 mt-2 mt-md-3">
                    ...
                    <span class="text-white ml-2">7.4 <span style="background-color: #F5C518; color: black; margin-left:5px; padding: 3px; border-radius: 5px;" >IMDb </span></span>
                  </div>
                  <div class="d-flex align-items-center mt-2 mt-md-3">
              ...
              <div class="col-xl-6 col-lg-12 col-md-12">
                ...
                <div class="d-flex flex-wrap align-items-center fadeInLeft animated" data-animation-in="fadeInLeft"
                  ...
                  <div class="slider-ratting d-flex align-items-center mr-4 mt-2 mt-md-3">
                    ...
                    <span class="text-white ml-2">7.5 <span style="background-color: #F5C518; color: black; margin-left:5px; padding: 3px; border-radius: 5px;" >IMDb </span></span>
                  </div>
                  <div class="d-flex align-items-center mt-2 mt-md-3">
                    <span class="badge badge-secondary p-2">16+</span>
                ...
                <p data-animation-in="fadeInUp">
                  The story involves Maverick confronting his past while training a group of younger Top Gun graduates, 
                  ...
                  <div class="block-images position-relative">
                    ...
                    <div class="block-description">
                      ...
                      <div class="hover-buttons">
                        <span class="btn btn-hover iq-button" onclick="redirectToMovie(<?php echo $row['id']; ?>)">
                ...
                <li>
                    <div class="block-images position-relative">
                      ...
                      <div class="block-description">
                        ...
                        <div class="hover-buttons">
                          <a href="#" class="btn btn-hover" tabindex="0" onclick="redirectToMovie('<?php echo $row['id']; ?>')">
            ...
            <div class="trending-contens">
              <ul id="trending-slider-nav" class="list-inline p-0 mb-0 row align-items-center">
                ...
                <?php
                 ...
                 $all_series = $conn->query($sql);
                 while($row = mysqli_fetch_assoc($all_series)){ ?>
                          <a href="javascript:void(0);">
                            <div class="movie-slick position-relative">
                              <img src="images/trending/<?php echo $row['image']; ?>" class="img-fluid" alt="">
                            </div>
                          </a>
                        </li>
                 <?php } ?> 
              ...
              <?php
                ...
                <li>
                  ...
                  <div class="tranding-block position-relative" style="background-image: url('images/trending/<?php echo $row['image']; ?>');">
                    ...
                    <div class="trending-content">
                        ...
                        <div id="trending-data1" class="overview-tab tab-pane fade active show">
                          ...
                          <div class="trending-info align-items-center w-100 animated fadeInUp">
                            ...
                            <h1 class="trending-text big-title text-uppercase"><?php echo $row['title']; ?></h1>
                            ...
                            <div class="d-flex align-items-center series mb-4">
                              <a href="javascript:void(0);">
                                <img src="images/trending/" class="img-fluid" alt="">
                              </a>
...
function redirectToMovie(movieId) {
  // Redirect to moviedata.php with the movieId as a query parameter
  window.location.href = 'MovieData.php?movie_id=' + movieId;
}
</script>
